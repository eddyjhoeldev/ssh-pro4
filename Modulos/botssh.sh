...
if ps x | grep "bot_plus"|grep -v grep 1>/dev/null 2>/dev/null; then
   clear
   echo -e "\033[1;32mO BOT SSHPLUS YA ESTA ACTIVO !\033[0m"
   sleep 3
   bot_telegram
 else
   clear
...
echo ""
 if ps x | grep "bot_plus"|grep -v grep 1>/dev/null 2>/dev/null; then
   ...
   echo ""
   echo -e "\033[1;32mO BOT SSHPLUS YA ESTA DESACTIVADO!\033[0m"
   sleep 3
   bot_telegram
 fi
}
function token_edit () {
  ...
  cd $HOME
  clear
  echo -ne "\033[1;32mTOKEN ALTERADO CON ÉXITO !\033[0m"
  sleep 3
  bot_telegram
}
function att_api () {
  ...
  cd $HOME
  echo ""
  echo -e "\033[1;36mAPI ATUALIZADA CON ÉXITO !\033[1;37m"
  sleep 2
  bot_telegram
}
reset_bot () {
...
statusbot="\033[1;31mDESACTIVADO"
fi
...
[\033[1;31m0\033[1;33m] VOLVER \033[1;32m<\033[1;33m<\033[1;31m< \033[0m"
echo ""
