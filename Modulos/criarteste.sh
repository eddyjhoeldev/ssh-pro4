...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-15s\n' "Crear usuario de prueba" ; tput sgr0
echo ""
...
then
echo ""
tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Nombre vacío o incorrecto." ; echo "" ; tput sgr0
	exit 1
fi
...
then
echo ""
tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Contraseña vacía o incorrecta." ; echo "" ; tput sgr0
	exit 1
fi
...
then
echo ""
tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Limite vacía o incorrecto." ; echo "" ; tput sgr0
	exit 1
fi
...
echo -e "\033[1;32m$nome \033[1;33msera desconectado o borrado.\033[0m"
exit
