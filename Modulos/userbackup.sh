...
echo ""
echo -e "\033[1;33m[\033[1;31m1\033[1;33m] \033[1;37m- \033[1;33mCREAR BACKUP"
echo -e "\033[1;33m[\033[1;31m2\033[1;33m] \033[1;37m- \033[1;33mRESTAURAR BACKUP"
echo -e "\033[1;33m[\033[1;31m3\033[1;33m] \033[1;37m- \033[1;33mVOLVER\033[1;37m"
echo ""
echo -ne "\033[1;32mQUE DESEA HACER\033[1;31m ?\033[1;37m : "; read opcao
if [[ "$opcao" = '1' ]]; then
	...
	then
		...
		echo ""
		echo -e "\033[1;32mBACUP CREADO CON ÉXITO !\033[0m"
		echo ""
        ...
        echo -e "\033[1;33mfoi creado com éxito no diretório \033[1;31m/root\033[0m"
		echo ""
	fi
fi
if [[ "$opcao" = '2' ]]; then
	...
	then
		...
		rm /backup.vps
		echo ""
		echo -e "\033[1;36mUsuários e\033[1;36m senhas importados com éxito.\033[0m"
		echo ""
		exit
	else
		echo ""
