...
if netstat -nltp|grep 'squid' 1>/dev/null 2>/dev/null;then
	...
	if [[ "$resp" = 's' ]]; then
	    ...
	    fun_bar 'rem_sqd'
	    echo ""
		echo -e "\033[1;32mSQUID REMOVIDO CON ÉXITO !\033[0m"
		sleep 3.5s
		clear
		fun_conexao
	else
...
fun_bar 'sqd_conf'
echo ""
echo -e "\033[1;32mSQUID INSTALADO CON ÉXITO!\033[0m"
sleep 3.5s
fun_conexao
fi
}
...
addpt_sqd () {
	...
	if grep -E "$pt" /etc/default/dropbear > /dev/null 2>&1; then
		...
		echo ""
		echo -e "\033[1;32mPORTA ADICIONADA CON ÉXITO!"
		sleep 3.5s
		clear
		fun_squid
	fi
...
rempt_sqd () {
	...
	if grep -E "$pt" $var_sqd > /dev/null 2>&1; then
		...
		fun_bar 'service squid restart' 'service squid3 restart'
		echo ""
		echo -e "\033[1;32mPORTA REMOVIDA CON ÉXITO!"
		sleep 3.5s
		clear
		fun_squid
	...
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		...
		if [[ "$resposta" = '1' ]]; then
			...
			if ps x | grep "limiter"|grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo ""
				echo -e "\033[1;31m LIMITER DESACTIVADO \033[0m"
				sleep 3
				fun_drop
			else
				echo ""
			...
			if grep -w "$pt" $var_sqd > /dev/null 2>&1
				...
				echo ""
				echo -e "\033[1;32mPORTA ALTERADA CON ÉXITO!"
				sleep 3.5s
				clear
				fun_conexao
			fi
			...
			echo ""
			echo -e "\033[1;32mDROPBEAR REMOVIDO CON ÉXITO !\033[0m"
			sleep 3
			clear
			fun_conexao
		...
		if [[ "$resposta" = 's' ]]; then
			...
			if [[ $sockspt = $porta ]]; then
				...
				if grep -w "$porta" $var_sqd > /dev/null 2>&1
					...
					echo -e "\033[1;33m[\033[1;31m3\033[1;33m] \033[1;33mVOLVER\033[0m"
					echo ""
					echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m?\033[1;37m "; read resp
					if [[ "$resp" = '1' ]]; then
						sleep 1
			...
			echo ""
			echo -e "\033[1;31m● \033[1;33mDropBear instalado e configurado com éxito\033[0m"
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
	...
	echo ""
	netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mPORTA ALTERADA CON ÉXITO !" || echo -e "\033[1;31mERRO INESPERADO!"
	sleep 3.5s
	clear
	fun_conexao
	fi
...
connect = 127.0.0.1:22" > /etc/stunnel/stunnel.conf
    ...
    fun_bar 'fun_finssl'
    echo ""
    netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mSSL TUNNEL INSTALADO CON ÉXITO !\033[1;31m PORTA: \033[1;33m$porta" || echo -e "\033[1;31mERRO INESPERADO!"
    sleep 4
    clear
    fun_conexao
    else
...
[\033[1;31m0\033[1;33m] VOLVER\033[0m"
echo ""
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		echo -e "\033[1;33m[\033[1;31m0\033[1;33m] \033[1;33mVOLVER"
		echo ""
		echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m?\033[1;31m?\033[1;37m "; read option
		case $option in
			1) 
			clear
		    ...
		    fun_bar 'fun_opn'
		    echo ""
		    echo -e "\033[1;32mPORTA ALTERADA CON ÉXITO!\033[1;33m"
		    sleep 3
		    fun_conexao
			;;
			2) 
			...
			echo -e "\033[1;33m[\033[1;31m0\033[1;33m] \033[1;33mVOLVER"
			echo ""
			echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m?\033[1;31m?\033[1;37m "; read resp
			if [[ -z "$resp" ]]; then
				echo ""
				echo -e "\033[1;31mOpción incorrecta!"
				sleep 3
				fun_openvpn
			fi
			if [[ "$resp" = '1' ]]; then
				...
				echo ""
				echo -e "\E[44;1;37m      Host adicionado com éxito !      \E[0m"
			    sleep 2
			    exit 1
			elif [[ "$resp" = '2' ]]; then
				clear
				...
				if [[ -z $option ]]; then
					echo ""
					echo -e "\E[41;1;37m          Opción incorrecta  !        \E[0m"
					sleep 2
					fun_openvpn
				fi
				...
				echo "$hst" > /etc/hosts
				echo ""
				echo -e "\E[41;1;37m      Host removido com éxito !      \E[0m"
			    sleep 2
			    fun_openvpn
			elif [[ "$resp" = '3' ]]; then
				echo ""
			    ...
			    nano /etc/hosts
			    echo ""
			    echo -e "\033[1;32mALTERADO CON ÉXITO!\033[0m"
			    sleep 3
			    fun_openvpn
			elif [[ "$resp" = '0' ]]; then
				echo ""
...
float" > /etc/openvpn/client-common.txt
	...
	newclient "SSHPLUS"
	echo ""
	echo -e "\033[1;32mOPENVPN INSTALADO CON ÉXITO\033[0m"
fi
...
fun_socks () {
	...
	if [[ "$resposta" = '1' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
		    ...
		    echo ""
		    echo -e "\033[1;32mPROXY SOCKS ATIVADO CON ÉXITO\033[1;33m"
		    sleep 3
		    fun_socks
		fi
	elif [[ "$resposta" = '2' ]]; then
...
statuslimit="\033[1;31mDESACTIVADO"
fi
...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo ""
echo -e "                \033[1;33m● \033[1;36mMODO DE CONEXIÓN \033[1;33m●\033[0m"
echo ""
...
[\033[1;31m6\033[1;33m] VOLVER \033[1;32m<\033[1;33m<\033[1;31m< \033[1;33m
