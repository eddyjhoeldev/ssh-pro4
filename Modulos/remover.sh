...
echo -e "\033[1;33m[\033[1;31m3\033[1;33m]\033[1;33m VOLVER"
echo ""
...
then
	...
	if [ "$(cat "$database"| grep -w $user| wc -l)" -ne "0" ]
		...
		if [[ `grep -c $user /tmp/rem` -eq 0 ]]
			...
			echo ""
			echo -e "\E[41;1;37m Usuario $user removido com éxito! \E[0m"
	...
	echo -e "\n\033[1;33mAguarde\033[1;32m.\033[1;31m.\033[1;33m.\033[0m"
        ...
        rm *.zip > /dev/null 2>&1
		echo -e "\n\033[1;32mUSUARIOS REMOVIDOS CON ÉXITO!\033[0m"
		sleep 2
		menu
	else
	...
	echo -e "\n\033[1;31mOpción incorrecta !\033[0m"
	sleep 1.5s
	menu
fi