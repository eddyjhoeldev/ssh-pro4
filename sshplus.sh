...
clear
[[ "$EUID" -ne 0 ]] && echo -e "\033[1;33mDisculpe, \033[1;33mes necesario ejecutar como root\033[0m" && rm -rf $HOME/Plus > /dev/null 2>&1 && return 1
cd $HOME
fun_bar () {
comando[0]="$1"
comando[1]="$2"
...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%40s%s%-12s\n' "BIENVENIDO AL ADMINISTRADOR DROPLET 1.2" ; tput sgr0
echo -e "\033[1;32m                    CONTACTO: +924177369      "
echo -e "\033[1;31m════════════════════════════════════════════════════\033[0m"
echo ""
...
sleep 2
echo ""
echo -ne "\033[1;36mIngrese su nombre:\033[1;37m "; read name
if [ -z "$name" ]; then
  echo ""
  echo -e "\033[1;31mErro \033[1;32mNombre vacio!\033[0m"
...
echo ""
echo -ne "\033[1;36mPara continuar confirme su IP \033[1;37m"; read -e -i $IP ipdovps
if [ -z "$ipdovps" ]; then
  echo ""
...
then
    ...
    echo ""
    echo -e "\033[1;33m[\033[1;31m1\033[;33m] Mantener la base de datos actual\033[0m"
    echo -e "\033[1;33m[\033[1;31m2\033[1;33m] Crear una base de datos nueva\033[0m"
    echo ""
    echo -e "\033[0;34m═════════════════════════════════════════════════\033[0m"
    echo ""
...
echo ""
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%35s%s%-18s\n' " AGUARDE LA INSTALACIÓN" ; tput sgr0
echo ""
echo ""
echo -e "           \033[1;33m● \033[1;32mAtualizando Sistema \033[1;33m●\033[0m"
echo ""
echo -e "    \033[1;33mActualizaciones suele tardar un poco!\033[0m"
echo ""
fun_attlist () {
    apt-get update -y
...
clear
echo ""
echo -e "           \033[1;33m● \033[1;32mInstalando Paquetes \033[1;33m●\033[0m"
echo ""
...
echo ""
echo -e "\033[0;34m═════════════════════════════════════════════════\033[0m"
echo -e "         \033[1;33m● \033[1;32mINSTALACIÓN CONCLUIDA \033[1;33m●\033[0m"
echo ""
echo -e "\033[1;31m● \033[1;33mProxy Squid Instalado, puertas: 80, 8080, 3128\033[0m"
echo -e "\033[1;31m● \033[1;33mOpenSSH funcionando en las puertas 22 e 443\033[0m"
echo -e "\033[1;31m● \033[1;33mSScript para la administración de usuarios instalados\033[0m"
echo -e "\033[1;31m● \033[1;33mComandos disponibles Ejecutar \033[1;32mmenu \033[1;33mou \033[1;32majuda\033[0m"
echo -e "\033[0;34m═════════════════════════════════════════════════\033[0m"
echo ""
